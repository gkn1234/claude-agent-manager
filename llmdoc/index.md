...
| 文档 | 描述 |
|---|---|
| [config-keys](reference/config-keys.md) | 所有运行时配置键：调度参数（max_concurrent、poll_interval、command_timeout、log_retention_days）、API 验证规则，以及认证环境变量（AUTH_PASSWORD、AUTH_SECRET）。init_prompt 和 research_prompt 已移除。 |
